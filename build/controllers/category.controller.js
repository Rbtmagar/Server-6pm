...
exports.create = (0, async_handler_utils_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!category) {
        throw new error_handler_middleware_1.CustomError("Category not created", 401);
    }
    res.status(201).json({
...
exports.update = (0, async_handler_utils_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (category.user !== user._id) {
        throw new error_handler_middleware_1.CustomError("Only category owner can perform this operation.", 403);
    }
    category.name = name;
...
exports.getAll = (0, async_handler_utils_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const categories = yield category_model_1.default.findOne({});
    res.status(201).json({
...
exports.remove = (0, async_handler_utils_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (category.user !== user) {
        throw new error_handler_middleware_1.CustomError('You can not perform this action', 403);
    }
