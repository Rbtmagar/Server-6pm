...
const hash = (value) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield bcryptjs_1.default.hash(value, salt);
});
exports.hash = hash;
/**
 ...
 */
const compare = (value, hashedValue) => __awaiter(void 0, void 0, void 0, function* () {
    return yield bcryptjs_1.default.compare(value, hashedValue);
});
