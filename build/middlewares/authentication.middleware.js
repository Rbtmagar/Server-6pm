...
const Authenticate = (roles) => {
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            if (!auth_header) {
                throw new error_handler_middleware_1.CustomError('Authorization header is missing', 401);
            }
            if (!auth_header.startsWith('BEARER')) {
                throw new error_handler_middleware_1.CustomError('c', 401);
            }
            // get token
            ...
            // verify token
            const decoded = (0, jwt_utils_1.verifyJwtToken)(token);
            // expiry of token
            if ((decoded === null || decoded === void 0 ? void 0 : decoded.exp) && decoded.exp * 1000 < Date.now()) {
                throw new error_handler_middleware_1.CustomError('Access token is expired, access denied', 400);
            }
            // search for user
